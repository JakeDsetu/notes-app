...
class NoteAPITest {
    ...
    @BeforeEach
    fun setup(){
        learnKotlin = Note("Learning Kotlin", "Begin learning Kotlin properly", 5, "College", true)
        summerHoliday = Note("Summer Holiday to France", "Don't forget your phone charger!", 1, "Holiday", true)
        codeApp = Note("Code App", "Make an app using Kotlin", 4, "Work", false)
        testApp = Note("Test App", "Write Junit5 tests for the app", 4, "Work", false)
        swim = Note("Swim - Pool", "Attend swimming lessons", 3, "Hobby", false)
    ...
    inner class AddNotes {
        ...
        fun `adding a Note to a populated list adds to ArrayList`() {
            val newNote = Note("Study Lambdas", "Study how to use Lambdas in Kotlin", 1, "College", false)
    ...
    inner class UpdateNotes {
        ...
        fun `updating a note that does not exist returns false`(){
            assertFalse(populatedNotes!!.updateNote(6, Note("Updating Note", "Updating my note",2, "Work", false)))
            assertFalse(populatedNotes!!.updateNote(-1, Note("Updating Note", "Updating my note", 2, "Work", false)))
            assertFalse(emptyNotes!!.updateNote(0, Note("Updating Note", "Updating my note",2, "Work", false)))
        }
        ...
        fun `updating a note that exists returns true and updates`() {
            ...
            assertTrue(populatedNotes!!.updateNote(4, Note("Updating Note", "Updating my note",2, "College", false)))
